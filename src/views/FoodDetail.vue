          ...
          <div class="col-md-6">
              ...
              <form class="mt-4" v-on:submit.prevent>
                  ...
                  <div class="form-group">
                      ...
                      <textarea v-model="pesan.keterangan" class="form-control" placeholder="Keterangan request pesanan : pedas, mais, nasi setengah dll..."></textarea>
                  </div>
        ...
        pemesanan(){
            if(this.pesan.jumlah_pemesanan){
                ...
                .then(() => {
                    ...
                    this.$toast.success('Pesanan Telah Masuk Keranjang', {
                        type: 'success',
                        position: 'top-right',
                        duration: 3000,
                        dismissible: true
                ...
                this.$toast.error('Data pemesanan harus diisi', {
                        type: 'error',
                        position: 'top-right',
                        duration: 3000,
                        dismissible: true
